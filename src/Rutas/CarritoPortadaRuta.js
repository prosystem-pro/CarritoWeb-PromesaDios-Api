...
const Modelo = 'carritoportada';
const Tabla = 'CarritoPortada'
const { Listado, ObtenerPorCodigo, Buscar, Crear, Editar, Eliminar } = require('../Controladores/CarritoPortadaControlador');
